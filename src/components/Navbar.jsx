...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <div className=" text-base font-semibold  select-none relative  cursor-pointer ">YAHYA.DEV</div>
      ...
      >
        <li onClick={toggle} className="py-5 cursor-pointer  hover:text-main w-full mx-auto text-center rounded-lg">
          <a href="#home">Home</a>
        </li>
        <li onClick={toggle} className="py-5 cursor-pointer hover:text-main w-full text-center rounded-lg">
          <a href="#about">About</a>
        </li>
        <li onClick={toggle} className="py-5 cursor-pointer hover:text-main w-full text-center rounded-lg">
          <a href="#projects">Projects</a>
