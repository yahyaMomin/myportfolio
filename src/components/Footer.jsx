   ...
   return (
      <div className="title text-white gap-3 flex-col-reverse md:flex-row items-center bg-[#2d2e32] flex justify-between py-10 md:px-10">
         ...
         <div className="links flex gap-3 text-3xl">
            ...
            <a
               rel="noreferrer"
               href="https://firebasestorage.googleapis.com/v0/b/finstamiles-app.appspot.com/o/posts%2F1704917395244-YahyaMomin_CV.pdf?alt=media&token=8ce9ba8f-ce94-4fd6-b0e8-250aeb096602"
               target="_blank"
            >
               <FaImagePortrait />
            </a>
